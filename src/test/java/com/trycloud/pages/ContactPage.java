...
public List<String> getAllFolder(){
    List<WebElement>listName=Driver.getDriver().findElements(By.xpath("//div[@class='app-content-list-item']") );

   // System.out.println(BrowserUtil.getElementsText(listName));
    return BrowserUtil.getALlAtribute(listName);
}
}
